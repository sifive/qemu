                                    ...
                                    target_ulong val)
{
    ...
    uint64_t cfi_mask = (MENVCFG_LPE | MENVCFG_SSE);
                                    ...
                                    target_ulong val)
{
    ...
    RISCVException ret;
    uint64_t cfi_mask = (SENVCFG_LPE | SENVCFG_SSE);
    ...
    /* If any cfi enabling bit changes in senvcfg, flush tlb */
    if ((val ^ env->senvcfg) & cfi_mask) {
        tb_flush(env_cpu(env));
    }
                                    ...
                                    target_ulong val)
{
    ...
    uint64_t cfi_mask = (HENVCFG_LPE | HENVCFG_SSE);
    RISCVException ret;
