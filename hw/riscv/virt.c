...
WGCInfo virt_wgcinfo[] = {
    [WGC_DRAM]  = { VIRT_WGC_DRAM, VIRT_WGC_DRAM_IRQ, 16 },
    [WGC_FLASH] = { VIRT_WGC_FLASH, VIRT_WGC_FLASH_IRQ, 16 },
    [WGC_UART]  = { VIRT_WGC_UART, VIRT_WGC_UART_IRQ, 1 },
};
