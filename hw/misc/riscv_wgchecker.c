    ...
    WgCheckerRegion *region, hwaddr addr, uint32_t wid, bool is_write)
{
    ...
    if (!be && !ip) {
         ...
         * update the errcause or erraddr registers.
         */
                                               ...
                                               unsigned size, MemTxAttrs attrs)
{
    ...
    trace_riscv_wgc_mem_blocked_read(addr, size, attrs.secure);
                                               ...
                                               unsigned size, MemTxAttrs attrs)
{
    ...
    trace_riscv_wgc_mem_blocked_write(addr, value, size, attrs.secure);
...
static Property riscv_wgchecker_properties[] = {
    ...
    DEFINE_PROP_BOOL("used-for-boot", RISCVWgCheckerState, used_for_boot, false),
